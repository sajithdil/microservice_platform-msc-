...
router.post('/', function(req, res, next) {
  ...
  var collection = db.get('db_handling');
    ...
    var obj = collection.update({"username":req.body.username,"proj":req.body.proj,"id":req.body.id},{"username":req.body.username,"proj":req.body.proj,"id":req.body.id,"db":req.body.db},{upsert:true},function(err,data){
        if(err)
        {
            res.status(500).send(err);
            return;
